...
import 'package:WalpaperApp/Model/WallpaperModel.dart';
import 'package:WalpaperApp/data/Data.dart';
import 'package:WalpaperApp/views/Category.dart';
import 'package:WalpaperApp/views/Search.dart';
import 'package:WalpaperApp/views/image_view.dart';
import 'package:WalpaperApp/widgets/widget.dart';
...
class _State extends State<HomePage> {
  ...
  getTrendWallpapers() async {
    var responsed = await http.get(
        "https://api.pexels.com/v1/curated?per_page=15&page=15",
